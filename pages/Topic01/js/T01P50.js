...
var updateContentArray = [
    ...
    animation: [
      {
        target: ".clsPatch",
        duration: "0.5",
        activity: { display: "block", opacity: "1" },
      },
    ],
  },
  {
...

  {
    ...
    transcript: "",
    animation: [
      { target: ".paraText", duration: "0.5", activity: { display: "block" } },
    ],
  },
...

  {
    ...
    transcript: "",
    animation: [
      { target: ".Clsback2", duration: "0.5", activity: { display: "block" } },
    ],
  },
...

  {
    ...
    transcript: "",
    animation: [
      { target: "#para1", duration: "0.5", activity: { display: "list-item" } },
    ],
  },

  {
    ...
    transcript: "",
    animation: [
      { target: "#para2", duration: "0.5", activity: { display: "list-item" } },
    ],
  },

  {
    ...
    transcript: "",
    animation: [
      { target: "#para3", duration: "0.5", activity: { display: "list-item" } },
    ],
  },

  {
    ...
    transcript: "",
    animation: [
      { target: "#para4", duration: "0.5", activity: { display: "list-item" } },
    ],
  },

  {
    ...
    transcript: "",
    animation: [
      { target: "#para5", duration: "0.5", activity: { display: "list-item" } },
    ],
  },

  {
    ...
    transcript: "",
    animation: [
      { target: "#para6", duration: "0.5", activity: { display: "list-item" } },
    ],
  },
...
function myFunction() {
  ...
  if (value > 0 && value < 10) {
    ...
    imageEl.attr(
      "src",
      "pages/images/Topic01/T01P50/T01P50_02.gif?" + Math.random()
    );
    ...
    imagePl.attr(
      "src",
      "pages/images/Topic01/T01P50/T01P50_03.gif?" + Math.random()
    );
  }
}
